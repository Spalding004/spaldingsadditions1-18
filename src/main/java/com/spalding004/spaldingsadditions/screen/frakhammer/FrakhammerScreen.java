...
public class FrakhammerScreen extends AbstractContainerScreen<FrakhammerMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(SpaldingsAdditions.MOD_ID, "textures/gui/autofrak.png");
	private FuelBar fuelBar;

    
    
    public FrakhammerScreen(FrakhammerMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
    ...
    protected void renderBg(PoseStack pPoseStack, float pPartialTicks, int pMouseX, int pMouseY) {
        ...
        if(this.menu.isCrafting()) {
        	...
        	blit(pPoseStack, 75 + i, 45 + j, 0, 177, l, 16);
        }
    }
