...
public class EndedPortalStructure extends StructureFeature<JigsawConfiguration> {

    public EndedPortalStructure(boolean nether) {
        super(JigsawConfiguration.CODEC, EndedPortalStructure::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!EndedPortalStructure.isFeatureChunk(context)) {
            return Optional.empty();
        }
        
        int yToUse = EndedPortalStructure.getFeatureY(context);
        ...
        JigsawConfiguration newConfig = new JigsawConfiguration(
                ...
                () -> context.registryAccess().ownedRegistryOrThrow(Registry.TEMPLATE_POOL_REGISTRY)
                        .get(new ResourceLocation(SpaldingsAdditions.MOD_ID, "ended_portal/start_pool")),
        ...
        if(structurePiecesGenerator.isPresent()) {
           ...
           System.out.println( "Endedportal at " + blockpos);
        }
